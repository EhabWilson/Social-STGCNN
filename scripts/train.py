...
from metrics import *
from models.model import social_stgcnn
...
parser.add_argument('--tag', default='', type=str, help='personal tag for the model ')
...
log_dir = os.path.join(
    'runs', current_time + '_' + socket.gethostname() + '/' + args.tag)
...
for epoch in range(args.num_epochs):
    ...
    # logging.info('*' * 30)
    # logging.info('Epoch:', args.tag, ":", epoch)
...
os.system("python ./scripts/test.py --log_dir {}".format(test_dir))
writer.close()
