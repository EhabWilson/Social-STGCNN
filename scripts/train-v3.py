...
parser.add_argument('--ilr', type=float, default=0.02, help='learning rate')
...
optimizer = optim.SGD(
    [
        {
            "params": model.st_gcns.parameters()
        },
        {
            "params": model.tpcnns.parameters()
        },
        {
            "params": model.tpcnn_ouput.parameters()
        },
        {
            "params": model.atten.parameters(),
            "lr": args.ilr,
        },
    ],
    lr=args.lr
