...
from utils import *
from data import TrajectoryDataset_Real
from metrics import *
...
def test(loader_test, model, writer=None, epoch=0, KSTEPS=20):
    ...
    for batch in loader_test:
        ...
        ratio = model(V_obs_tmp, A_obs.squeeze())
...
def test_main(args):
    ...
    for tag in DOMAINS:
        ...
        ratio = test(loader_test, model)
        
        print("The min, max, mean of the ratio is: ", min(ratio), max(ratio), math.mean(ratio))
