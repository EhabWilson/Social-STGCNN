...
class TrajectoryDataset(Dataset):
    ...
    def __init__(self,
        ...
        torch.save(deal_dict, data_dir+"vanda.pth")
...
class TrajectoryDataset_Real(Dataset):
    ...
    def __init__(self,
        ...
        - delim: Delimiter in the dataset files
        """
        super(TrajectoryDataset_Real, self).__init__()
        self.data_source = torch.load(data_dir+'vanda.pth')
        self.max_peds_in_frame = 0
        self.data_dir = data_dir
        self.obs_len = obs_len
        self.pred_len = pred_len
        ...
        #Convert to Graphs
        print("Loading Data from previous pre-process .....")
        self.v_obs = self.data_source["v_obs"]
        self.A_obs = self.data_source["A_obs"]
        self.v_pred = self.data_source["v_pred"]
        self.A_pred = self.data_source["A_pred"]
